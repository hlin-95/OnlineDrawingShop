<nav id="mainNavbar" class="navbar navbar-dark navbar-expand-sm py-0 fixed-top">
    <a href="/onlineDrawingShop/user/home?name=${currentUser}" class="navbar-brand">LIN's</a>
    ...
    <div class="collapse navbar-collapse" id="navLinks">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="/onlineDrawingShop/user/home?name=${currentUser}" class="nav-link" id="home">HOME</a>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <c:url value="/user/getProducts" var="productUrl"></c:url>
                    <a class="dropdown-item" id="allThemes" href="/onlineDrawingShop/user/shopAll?name=${currentUser}">All themes</a>
            ...
            <li class="nav-item">
                <a href="/onlineDrawingShop/user/contact?name=${currentUser}" class="nav-link" id="contact">CONTACT</a>
            </li>
        </ul>

        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="/onlineDrawingShop/user/like?name=${currentUser}" class="nav-link" id="like">
                    <img src='<c:url value="/resources/icon/heart.webp"/>'/>LIKE
                </a>
            </li>
            <li class="nav-item">
                <a href="/onlineDrawingShop/user/profile?name=${currentUser}" class="nav-link" id="account">
                    <img src='<c:url value="/resources/icon/account.webp"/>'/><c:if test="${not empty currentUser}">${currentUser}</c:if>
                    </a>
            </li>
            <li class="nav-item">
