...
<head>
    <%@ include file="header.jsp" %>
        <title>LIN's | EDIT SUCCESSFULLY</title>
</head>
    ...
    <%@ include file="navbarAdmin.jsp" %>
        <main>
            <section class="successForm">
                <h1>THANKS!</h1>
                <img src="https://i.ibb.co/GVvrWsp/check.webp" alt="check">
                <p>
                    You have edited the products successfully.
                </p>
                <a href="/onlineDrawingShop/admin/shopAll" class="button">GO TO PRODUCTS</a>
            </section>
        </main>
        <style>
