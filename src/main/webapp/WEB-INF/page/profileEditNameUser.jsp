                ...
                $.post($("#customer").attr("action"),
                    ...
                    function (response) {
                        if (response === "nextStep") {
                            ...
                            alert("Error.");
                            window.location.href = "/onlineDrawingShop/user/profileEditName?name=${currentUser}";
                        }
                    }
                )
                })
...
<body>
    ...
    <%@ include file="navbarUser.jsp" %>
        ...
        <main>
            <form id="customer" class="registerForm" action="/onlineDrawingShop/user/edit?info=name" method="post" modelAttribute="customer">
